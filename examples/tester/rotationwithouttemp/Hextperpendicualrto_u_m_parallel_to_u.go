//This example investigates the speed of roation of a single particle when the anisotropy axis, parallel to m, is perpendicual to the external field, without temperature
package main
...
func main() {
	...
	B_ext = func(t float64) (float64, float64, float64) { return 0, 0, 5e-3 }
	...
	//initialise the magnetisation along the anisotropy-axis
	M_uniform(0,1,0)
