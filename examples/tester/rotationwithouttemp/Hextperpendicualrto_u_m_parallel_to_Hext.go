//This example investigates the speed of roation of a single particle when the anisotropy axis, is perpendicual to the external field and m is parallel to H_ext, without temperature
package main
