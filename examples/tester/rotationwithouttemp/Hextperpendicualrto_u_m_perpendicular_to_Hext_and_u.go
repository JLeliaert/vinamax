//This example investigates the speed of roation of a single particle when the anisotropy axis, is perpendicual to the external field and m is perpendicualr to both without temperature
package main
...
func main() {
	...
	//initialise the magnetisation along H_ext
	M_uniform(1,0,0)
