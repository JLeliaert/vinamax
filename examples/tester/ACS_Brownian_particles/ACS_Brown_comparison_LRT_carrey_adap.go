...
func main() {
	...
	Particle_radius(6e-9)
	Particle_radius_h(6.5e-9)
	...
	B_ext = func(t float64) (float64, float64, float64) { return 0, 0, 1e-3*math.Cos(2*math.Pi*t*120e3)}//field is 97 kHz which is abut 1/taub 
	...
	//anisotropy axis is with respect to z %chi_o checken
