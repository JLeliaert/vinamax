...
plot filenofmm using ($1*1e9):2 ls 1 w l title "brute force <m_x>",\
 ...
 file u ($1*1e9):2 every 10 pt 7 lc 1 w p t "fast multipole <m_x>",\
 file u ($1*1e9):3 every 10 pt 7 lc 2 w p t "fast multipole <m_y>",\
 file u ($1*1e9):4 every 10 pt 7 lc 3 w p t "fast multipole <m_z>",\
