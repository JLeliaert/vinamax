	...
	case "dopri":
		{
			...
			solver.bt[1][0] = 1.
			solver.bt[2] = []float64{21., 22.}
			solver.bt[3] = []float64{31., 32., 33.}
			solver.bt[4] = []float64{41., 42., 43., 44.}
			solver.bt[5] = []float64{51., 52., 53., 54., 55.}
			solver.bt[6] = []float64{61., 62., 63., 64., 65., 66.}
